...
public class ChainTest {
    @Test
    public void should_calculate_multiples_3() throws Exception {
        Chain sut = new Chain();
    ...
    @Test
    public void should_calculate_multiples_5() throws Exception {
        Chain sut = new Chain();
    ...
    @Test
    public void should_calculate_multiples_15() throws Exception {
        Chain sut = new Chain();
    ...
    @Test
    public void should_calculate_any() throws Exception {
        Chain sut = new Chain();
